...
async function main() {
    console.log('--- Debugging Balance Logic (With PG Adapter) ---');
    ...
    for (const user of users) {
        ...
        // created_at might be Date object or string depending on driver, ensure Date
        ...
        const eligible = payments.filter(p => {
            ...
            else console.log(`- Payment ${p.id}: ACCEPTED (${p.amount})`);
